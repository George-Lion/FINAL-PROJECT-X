        ...
        <div className="contenedor-perfil">
          <div
            ...
            style={{
              backgroundImage:
                "url(" +
                "https://images.pexels.com/photos/889930/pexels-photo-889930.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" +
                ")",
            }}
          >
            ...
            <div className="datos-perfil">
              <h4 className="titulo-usuario">
                <i className="rute fas fa-map-marker-alt"></i>ISLAS TIKI TIKI
              </h4>
            </div>
            <div className="datos-button">
              <ul className="lista-perfil">
                <li>
                  <button type="button" className="mach-button btn btn-light ">
                    I'm in
                  </button>
                </li>
              </ul>
        ...
        <div className="container">
          <div className="placeDescription py-3 my-4 border-top border-bottom ">
            <p className="textDescription ">
              It is one of my favorite sites, to enjoy and clear the daily
              routine, cheer up, I await your requests, It is one of my favorite
              sites, to enjoy and clear the daily routine, cheer up, I await
              your requests.
            </p>
          </div>
          <div className="d-flex justify-content-center">
            <p className="features">
              <i className="icon fas fa-clock"></i> August 12 - August 17
            </p>
            <p className="features">
              <i className="icon fas fa-user-friends"> </i>2-4
            </p>
            <p className="features">
              <i className="icon fas fa-route"></i> Car
            </p>
            <p className="features">
              <i className="icon fas fa-coins"></i> 600€
            </p>
          </div>
          {/* información de viaje */}
          <div
            className="box position-static d-block py-3"
            tabIndex="-1"
            role="dialog"
            id="modalChoice"
          >
            ...
            <div className="mt-3 d-flex justify-content-center">
              {peopleCards.map((e) => {
                return (
                  <div
                    className="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg m-3"
            ...
            <div className="m-3 d-flex justify-content-center">
              <div className="card m-3" style={{ width: "60rem" }}>
                <img
                  src="https://previews.123rf.com/images/ihorbiliavskyi/ihorbiliavskyi2003/ihorbiliavskyi200300220/142866914-city-map-navigation-gps-navigator-distance-point-marker-icon-top-view-view-from-above-abstract-backg.jpg"
